    ...
    for attack in pokemons1:
        ...
        for defense in pokemons2:
            ...
            if len(attack) >= 2 and len(defense) ==1:
                ...
                for i in range(0,len(duo_list),len(attack)):
                    for num in duo_list[i:i+len(attack):]:
                        resultduel = resultduel * num
                    duels.append(resultduel)
                    resultduel = 1   
...
def game(number1,number2,listpok):
    listpok = listpok.split(",")
    pokemons1 = listpok[0:number1:]
    pokemons2 = listpok[number1:number2+number2:]
